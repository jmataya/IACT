<?php
/*
Plugin Name: Submit Surgical User
Plugin URI: http://www.iactpgh.com
Description: Submit a new entry for an event participant.
Author: Jeff Mataya
Version: 1
Author URI: http://www.iactpgh.com
*/

function submitSurgicalUser()
{
...
function widget_submitSurgicalUser($args)
{
    extract($args);
    echo $before_widget;
...
function mySubmitSurgicalUser_init()
{
    register_sidebar_widget(__('Submit Surgical User'), 'widget_mySubmitSurgicalUser');
}
add_action("plugins_loaded", "mySubmitSurgicalUser_init");
?>
