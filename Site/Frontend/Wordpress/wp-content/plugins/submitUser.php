...
function widget_submitUser($args)
{
    extract($args);
    echo $before_widget;
...
function mySubmitUser_init()
{
    register_sidebar_widget(__('Submit User'), 'widget_mySubmitUser');
}
add_action("plugins_loaded", "mySubmitUser_init");
?>
